...
class CategoryController extends Controller
{
    ...
    public function delete(Request $request)
    {
      ...
      try{
        ...
        if($category->subcate()->count() != 0){
          throw new Exception(__('This category belongs to a  subcategory'));
        }
        $category->delete();
    ...
    public function get(Request $request){  //paginated
      ...
      try
      {
        ...
        {
          $categoriesSubcategory = CategorySubcategory::where('subcategory_id', $request->subcategory_id)->pluck('category_id')->toArray();
          $categories = $categories->whereIn('id',$categoriesSubcategory);
          // dd($categories);
        }
