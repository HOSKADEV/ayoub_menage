...
<h4 class="fw-bold py-3 mb-3">
  <span class="text-muted fw-light">{{__('Purchase')}} /</span> {{__('Items')}}
    <button type="button" class="btn btn-primary" id="create" style="float:right">{{__('Add item')}}</button>
    <input type="text" class="form-control" id="purchase_id" value="{{$purchase->id}}" hidden/>
    <input type="text" class="form-control" id="supplier_id" value="{{$purchase->supplier_id}}" hidden/>
</h4>
        ...
        <form class="form-horizontal" onsubmit="event.preventDefault()" action="#"
          ...
          <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input class="fom-control" type="hidden" id= "name" name="name"/>
...
<script>
  $(document).ready(function(){
    ...
    $('#category').on('change', function() {
          ...
          success:function(response){
              if(response.status==1){
                ...
                for (var i = 0; i<response.data.length; i++){
                    ...
                    option.setAttribute('price',response.data[i].purchasing_price)
      ...
      $(document.body).on('change', '#product', function(event) {
