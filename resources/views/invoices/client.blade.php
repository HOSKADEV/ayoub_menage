...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>رقم الفاتورة: Maurizon-00{{$invoice->id}}</p>
                ...
                <tbody>
                    @foreach ($items as $item)
                      ...
                      <tr>
                        ...
                        <td class="total"> {{ $invoice->total_amount }} MRU </td>
                      </tr>
                </tbody>
            </table>
        </div>
