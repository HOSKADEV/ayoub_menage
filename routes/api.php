...
Route::post('/v1/similar-product', [SimilarProductController::class, 'index']);
...
Route::post('/v1/auth/login-action', 'App\Http\Controllers\authentications\LoginBasic@login');

Route::post('/v1/categorySubcategory', [SubcategoryController::class, 'gatCategorySubcategory']);

// Route::post('/v1/user/login', [LoginController::class, 'index']);
/* Route::group(['middleware' => ['auth:sanctum']], function () {
  ...
  Route::post('/v1/product/get-details','App\Http\Controllers\ProductController@getDetails');
  ...
  Route::post('/v1/wilaya/get', [WilayasController::class, 'get']);
  Route::post('/v1/setting/get', [settingController::class, 'get']);

  // Route::get('/v1/order/get/deta','App\Http\Controllers\OrderController@getDeta');
...
Route::group(['middleware' => ['auth:sanctum']], function () {
  ...
  Route::post('/v1/wilaya/create', [WilayasController::class, 'create']);
  Route::post('/v1/wilaya/update', [WilayasController::class, 'update']);
  Route::post('/v1/wilaya/delete', [WilayasController::class, 'delete']);

  Route::post('/v1/settings/update',[settingController::class , 'update']);
